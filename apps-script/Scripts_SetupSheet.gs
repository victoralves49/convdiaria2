...
// One-shot: monta as 7 abas da planilha de destino com headers e fórmulas.
// A ser implementado na fase 2. Rodar UMA vez no editor (botão Run).
//
// Vai criar (na ordem definida em SHEET_TABS_ORDER):
...
function setupSheetTabs() {
  throw new Error('Não implementado (fase 2)');
}
